...
def process_song_file(cur, filepath):
    """
     process song file function will insert the song data to our data model we created for            analysis
    
    :param cur: psycopg2 connection cursor
    :param filepath: file path of data to load , wrangle and Analysis 
...
def process_log_file(cur, filepath):
    """"
    process log file function will insert the log data to our data model we created for            analysis
...
def process_data(cur, conn, filepath, func):
    """
    Read all the file in `our file path` and make the function `func` on it.
    :param cur: cursor of our database
    :param conn: psycopg2 connection object
    :param filepath: file path of the process data
    :param func: function to make on the specified file
    """
    all_files = []
